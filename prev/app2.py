...
def get_flight_status(flight_number):
    ...
    try:
        ...
        if "data" in data and len(data["data"]) > 0:
            ...
            # Validate necessary fields before accessing them
            ...
            return f"Sorry, I couldn't find information for flight number {flight_number}."
    except Exception as e:
        return f"An error occurred while fetching flight data: {e}"

# Function to remove bold formatting (**) and extra asterisks (*) from responses
